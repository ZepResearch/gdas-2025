...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>The Global Defence and Aviation Skills Conference 2025</p>
        </div>
        <div class="content">
            <p class="greeting">Dear ${data.name},</p>
            <div class="success-badge">✓ Registration Successful</div>
            
            <p>We're delighted to confirm your registration for The Global Defence and Aviation Skills Conference 2025 (GDAS 2025). Your participation will contribute to valuable discussions and knowledge exchange in defence, aviation, and aerospace education.</p>
            
            <div class="conference-description">
                <strong>About GDAS 2025:</strong> An international platform dedicated to shaping the future of defence, aviation, and aerospace education. Bringing together government leaders, defence institutions, university chancellors, TVET councils, and industry pioneers from across Europe and Asia to redefine how knowledge and skills are transferred in the rapidly evolving global security and aviation landscape.
            </div>
            ...
            <div class="venue-details">
                ...
                <p><strong>Dates:</strong> December 8th - 9th, 2025</p>
                <p><strong>Venue:</strong> Kuala Lumpur, Malaysia</p>
            </div>
            
            <div class="highlight-box">
                <h3>What's Next?</h3>
                <p>We'll send you detailed conference information, including the agenda, accommodation options, and venue specifics as we get closer to the event date.</p>
            </div>
            
            <p>If you have any questions or need assistance, please don't hesitate to contact our conference team at info@gdasconference.com .</p>
            
            <p>We look forward to your valuable participation in this important conference!</p>
            
            <p>Warm regards,<br>
            <strong>The GDAS 2025 Organizing Committee</strong></p>
        </div>
        <div class="footer">
            <p>© ${new Date().getFullYear()} The Global Defence and Aviation Skills Conference</p>
            <p>This is an automated confirmation. Please do not reply to this email.</p>
            <div class="social-links">
                <a href="https://gdasconference.com/">Website</a> |
                <a href="#">LinkedIn</a> |
                <a href="#">Twitter</a>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="conference-info">
                <p>The Global Defence and Aviation Skills Conference 2025 (GDAS 2025)</p>
                <p>International platform for defence, aviation, and aerospace education</p>
            </div>
        ...
        <div class="footer">
            <p>GDAS 2025 Admin Notification System</p>
        </div>
    </div>
</body>
</html>
