...
export async function POST(request) {
  try {
    ...
    const record = await pb.collection("GDAS_paper_form_submission").create(pbFormData)
    ...
    await resend.emails.send({
      from: "Conference <info@gdasconference.com>",
      to: data.email,
      subject:
        "Paper Submission Confirmation - GDAS Conference",
    ...
    await resend.emails.send({
      ...
      subject: "New Paper Submission - GDAS Conference",
