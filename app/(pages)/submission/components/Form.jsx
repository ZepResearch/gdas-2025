...
export default function PaperSubmissionForm() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-white rounded-lg shadow-md py-24 my-2">
      <Toaster position="top-right" />
      <h1 className="text-4xl font-bold text-center mb-6 text-gray-9  00">Paper Submission Form</h1>
