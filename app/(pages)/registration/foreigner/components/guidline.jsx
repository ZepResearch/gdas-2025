        ...
        <div className="grid gap-6 md:gap-4">
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={step.number}
                className="flex flex-col md:flex-row gap-4 p-4 rounded-lg border bg-card hover:bg-accent/10 transition-colors"
              >
                <div className="flex items-center gap-4 md:gap-6">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-primary-foreground font-bold text-lg flex-shrink-0">
                    {step.number}
                  </div>
