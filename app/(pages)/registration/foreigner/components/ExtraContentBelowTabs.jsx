 ...
 <section className="py-16 bg-gray-50">
  <div className="container mx-auto px-4">
    <div className="text-center mb-12">
      <h2 className="text-3xl md:text-5xl font-medium text-black mb-6">Registration Benefits</h2>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-w-7xl mx-auto">
      <div className="relative bg-white rounded-3xl border overflow-hidden p-6 shadow-sm group hover:shadow-md transition-all">
        ...
        <div className="relative">
          <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 p-0.5 mb-4">
  ...
  <section className="py-16 bg-gray-50">
    <div className="container mx-auto px-4">
      <div className="max-w-3xl mx-auto text-center">
        <div className="relative bg-white shadow-xl rounded-3xl overflow-hidden p-8 ">
          <div className="absolute -inset-px rounded-3xl bg-gray-100/20 opacity-50"></div>

          <div className="relative">
            <h3 className="text-2xl font-bold text-black mb-3">Ready to Join GDAS 2025?</h3>
            <p className="text-gray-700 mb-6">
              Register now to secure your spot at The Global Defence and Aviation Skills Conference 2025 .
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/submission">
                <Button className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full">Submit Your Paper</Button>
              </Link>
              <Link href="/contact">
                <Button
                  variant="outline"
