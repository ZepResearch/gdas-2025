            ...
            <div className="bg-white rounded-3xl border border-[#d3e4c5] overflow-hidden p-8 md:p-12 shadow-sm relative">
              ...
              <div className="flex flex-col items-center text-center mb-10">
                ...
                <p className="text-black text-lg max-w-2xl">
                  We encountered an issue while processing your payment for the 
The Global Defence and Aviation Skills Conference 2025
                </p>
              </div>
              ...
              <div className="space-y-6 mb-10">
                ...
                <div className="bg-orange-50 rounded-xl border border-[#d3e4c5] p-6">
                  <p className="text-black">
                    ...
                    <a href="mailto:info@gdasummit.org" className="text-black font-semibold hover:underline">
                     info@gdasummit.org
                    </a>{" "}
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/contact">
                  <Button
                    variant="outline"
                    className="border-black text-black hover:bg-blue-700/90 rounded-full w-full sm:w-auto"
                  >
                ...
                <Link href="/">
                  <Button
                    variant="ghost"
                    className="text-black hover:bg-blue-500 rounded-full w-full sm:w-auto"
                  >
