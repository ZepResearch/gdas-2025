          ...
          <div className="px-8 py-6 space-y-8">
            ...
            <div className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed">
                The Global Defence and Aviation Skills Conference 2025 (GDAS2025) is committed to fostering an inclusive, accessible, and discrimination-free environment for all participants, regardless of physical, sensory, intellectual, or mental health conditions.
              </p>
            </div>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                GDAS2025 strictly prohibits any form of discrimination, harassment, or exclusion based on disability. All conference organizers, staff, and participants are expected to support and uphold the principles of inclusivity and equal access to conference activities, both in physical and virtual formats.
              </p>
            </section>
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700 text-sm">
                    The conference venue in Selangor/Kuala Lumpur will comply with international accessibility standards, including barrier-free access to conference halls, restrooms, and networking areas.
                  </p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-700 text-sm">
                    Conference materials, including programs, presentations, and TVET resources, will be available in accessible formats upon request.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                GDAS2025 will provide reasonable accommodations to ensure the full participation of individuals with disabilities, which may include:
              </p>
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-lg border-l-4 border-blue-600">
                <p className="text-gray-700 text-sm">
                  <strong>Note:</strong> Participants requiring accommodations are encouraged to notify the Organizing Committee in advance via info@gdasummit.org to ensure timely arrangements.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 text-sm">
                This policy is aligned with the UN Convention on the Rights of Persons with Disabilities (CRPD) and relevant national laws including Malaysian accessibility standards. The Organizing Committee will review and update this policy periodically to ensure best practices in inclusivity.
              </p>
            </section>
          </div>
        </div>
