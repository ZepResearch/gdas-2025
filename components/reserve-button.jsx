  ...
  return (
    <>
      ...
      >
        ...
        <Button   onClick={() => setIsOpen(true)}               className="bg-black text-white px-6 sm:px-8 py-6 rounded-lg font-semibold flex items-center justify-center gap-2 hover:bg-gray-900 transition-colors text-sm sm:text-base"
